...
async function sendMessage(message) {
    try {
        ...
        // Actualizar panel de depuración
        updateDebugPanel('Respuesta recibida', rawText, rawText);
...
async function handleSendMessage() {
    ...
    try {
        // Enviar mensaje al webhook y obtener respuesta en bruto
        const rawResponse = await sendMessage(message);
        
        // Ocultar indicador y mostrar respuesta en bruto
        hideTypingIndicator();
        addMessage(rawResponse, false);
